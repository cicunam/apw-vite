  ...
  return (
    ...
    <>
      <Flexbox justify="between" align="end" style={{ background:'#CFD5DC' }}>
        ...
        <Actions>
          { form.isDisabled && <Button icon="trash" color="secondary" onClick={form.handleDelete} /> }
          { form.isDisabled && <Button icon="pen" color="primary" onClick={form.handleEdit}>Editar</Button> }
          { !form.isDisabled && <Button icon="times" color="secondary" onClick={form.handleCancel} /> }
      ...
      <Routes>
        ...
        <Route path={organizer.currentPage + '/documentos'}>
          <Box space="medium large">
