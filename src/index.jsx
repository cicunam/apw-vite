...
import '@cicunam/sd/styles/tokens.css';
...
const reducer = (context, action) => {
  ...
  return { ...set(context, action.key, action.value) }; // NOTA: Es necesario regresar un objeto nuevo para que useContext() detecte el cambio!
